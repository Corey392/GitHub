<%-- @author     Adam Shortall, Todd Wiggins, Vince Lombardo
	 @version    1.013
	 ...
	 Change Log: 1.010: TW: Added our usernames into the drop down box to match the DB create script we are using.
	             1.011: TW: Removed default Username and Password (was a user that does not have access in our DB) and changed default value in drop down box to 'Select a User'. Added auto focus on page load to drop down box. Minor code clean up.
                     ...
                     03/08/2013: VL: Improved look and feel, added dropdown functionality seperating topics
...
display:none;
    ...
    <body>
        <div><h1>Click for more information:</h1></div>
        <!--Source: https://www.tafensw.edu.au/courses/rpl/#.UarZ2kBmiSo--> 
        <div id="heading1" class="heading">What is RPL Assist?<img src="images/1-navigation-expand.png" style="float:right" alt="" height="16" width="16" /></div>
        ...
        <div id="heading2" class="heading">What is credit?<img style="float:right" src="images/1-navigation-expand.png" alt="" height="16" width="16" /></div>
        ...
        <div id="heading3" class="heading">Who may apply for credit?<img style="float:right" src="images/1-navigation-expand.png" alt="" height="16" width="16" /></div>
        ...
        <div id="heading4" class="heading">How to apply for credit<img style="float:right" src="images/1-navigation-expand.png" alt="" height="16" width="16" /></div>
        ...
        <div id="heading5" class="heading">Evidence and assessment requirements<img id="image5" style="float:right" src="images/1-navigation-expand.png" alt="" height="16" width="16" /></div>
